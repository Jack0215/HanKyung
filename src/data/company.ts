...
export const CEO_GREETING = {
  ...
  paragraphs: [
    "안녕하십니까.",
    "(주)한경방재 대표 김석현입니다.",
    "(주)한경방재는 다년간 현장에서 축적한 기술과 경험을 바탕으로",
    "설계부터 시공, 사후관리까지 전 과정을 책임지는 방재 전문 기업입니다.",
    "신속한 판단과 정확한 시공, 그리고 끝까지 책임지는 자세로",
    "고객의 안전과 신뢰를 최우선 가치로 삼겠습니다.",
    "앞으로도 변화하는 환경에 발맞춰 능동적으로 대응하며",
    "기술력과 품질 경쟁력을 지속적으로 강화해",
